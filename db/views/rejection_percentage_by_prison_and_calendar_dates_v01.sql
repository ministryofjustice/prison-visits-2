SELECT rejected.prison_name,
       'total' AS reason,
       extract(year from rejected.created_at)::integer AS year,
       extract(month from rejected.created_at)::integer AS month,
       extract(day from rejected.created_at)::integer AS day,
