...
module PrisonVisits
  class Application < Rails::Application
    ...
    # If you want to record new/re-record VCR cassettes then you need to update the line below to 'config.call',
    # once completed you can return it to the value below so that the VCR cassettes will be used during testing
